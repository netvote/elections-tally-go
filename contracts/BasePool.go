...
func (_BasePool *BasePoolTransactor) CastVote(opts *bind.TransactOpts, voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.contract.Transact(opts, "castVote", voteId, vote, passphrase, jti)
}

// CastVote is a paid mutator transaction binding the contract method 0x4126ebe2.
//
// Solidity: function castVote(voteId bytes32, vote string, passphrase string, jti bytes32) returns()
func (_BasePool *BasePoolSession) CastVote(voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.Contract.CastVote(&_BasePool.TransactOpts, voteId, vote, passphrase, jti)
}

// CastVote is a paid mutator transaction binding the contract method 0x4126ebe2.
//
// Solidity: function castVote(voteId bytes32, vote string, passphrase string, jti bytes32) returns()
func (_BasePool *BasePoolTransactorSession) CastVote(voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.Contract.CastVote(&_BasePool.TransactOpts, voteId, vote, passphrase, jti)
}
...
func (_BasePool *BasePoolTransactor) UpdateVote(opts *bind.TransactOpts, voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.contract.Transact(opts, "updateVote", voteId, vote, passphrase, jti)
}

// UpdateVote is a paid mutator transaction binding the contract method 0xd6807a5c.
//
// Solidity: function updateVote(voteId bytes32, vote string, passphrase string, jti bytes32) returns()
func (_BasePool *BasePoolSession) UpdateVote(voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.Contract.UpdateVote(&_BasePool.TransactOpts, voteId, vote, passphrase, jti)
}

// UpdateVote is a paid mutator transaction binding the contract method 0xd6807a5c.
//
// Solidity: function updateVote(voteId bytes32, vote string, passphrase string, jti bytes32) returns()
func (_BasePool *BasePoolTransactorSession) UpdateVote(voteId [32]byte, vote string, passphrase string, jti [32]byte) (*types.Transaction, error) {
	return _BasePool.Contract.UpdateVote(&_BasePool.TransactOpts, voteId, vote, passphrase, jti)
}
